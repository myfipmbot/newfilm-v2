...
const infomsg = ` *KAVI EXE SYSTEM INFO* 🐋💗
        ...
        viewOnceMessage: {
          ...
          hasMediaAttachment: false
                    ...
                    buttonParamsJson: JSON.stringify({
                        display_text: 'KAVI EXE',
                        url: 'https://whatsapp.com/channel/0029Vb22FT9HFxOzBtWOwT0X',
                        merchant_url: 'https://whatsapp.com/channel/0029Vb22FT9HFxOzBtWOwT0X'
                    }),
                }]
    ...
    if (hasLeveledUp) {
        ...
        if (config.LEVEL_UP_MESSAGE === 'false') {
            await conn.sendMessage(from, {
                image: {
                    url: `https://telegra.ph/file/4b16a770470ba755cced5-df6883df1ddf5f1408.jpg`,
                },
                caption: `
━━━━━༺❃༻━━━━━◇
...
const config = require('../settings')
        const vcard = 'BEGIN:VCARD\n' +
            ...
            'END:VCARD'
        let buttonMessaged = {
            contacts: { displayName: 'Kavi', contacts: [{ vcard }] },
            contextInfo: {
                externalAdReply: {
                    title: 'Kavi',
                    body: 'Touch here.',
                    ...
                    thumbnailUrl: ``,
                    thumbnail: `https://telegra.ph/file/4b16a770470ba755cced5-df6883df1ddf5f1408.jpg`,
                    mediaType: 2,
                    mediaUrl: '',
...
async(conn, mek, m,{from, prefix, l, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply}) => {
try{       
if (!q) return mek.reply(`Example: ${prefix + command} hi 𝙠𝙖𝙫𝙞 play command is not working`)
...
await conn.sendMessage(from, {text: xeonlod[i], edit: key })
                  ...
                  await conn.sendMessage(`94760383959@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${mek.sender.split("@")[0]}\n\n*Bug Report*\n${q ? q : 'blank'}` })
...
await conn.sendMessage(from, {text: vajiralod[i], edit: key })
  ...
  const sections = [
	...
	rows: [
	    ...
	    {title: "2", rowId: prefix + 'ping' , description: '𝙆𝘼𝙑𝙄 𝙀𝙓𝙀 𝙎𝙋𝙀𝙀𝘿'} ,
...
let menuc = `*◈╾──────${category} DOWNLOAD COMMAND LIST──────╼◈*\n\n> Select you want command type and enjoy 𝙠𝙖𝙫𝙞 𝙚𝙭𝙚 whatsapp bot 🐋💗\n\n`;
        let wm = '*ᴋᴀᴠɪ ᴇxᴇ ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀ ʙᴏᴛ*\n*ᴋᴀᴠɪ ᴏꜰᴄ*'	
                ...
                cards: [
                  {
                    ...
                    header: proto.Message.InteractiveMessage.Header.create({
          ...(await prepareWAMessageMedia({ image: { url: 'https://files.catbox.moe/yl8w0e.jpeg' } }, { upload: conn.waUploadToServer })),
          title: menuc,
          gifPlayback: true,
          subtitle: "𝙆𝘼𝙑𝙄-𝙀𝙓𝙀",
          hasMediaAttachment: false
...
header: proto.Message.InteractiveMessage.Header.create({
          ...
          hasMediaAttachment: false
                    ...
                    nativeFlowMessage: {
                         ...
                         isForwarded: true,
                         forwardedNewsletterMessageInfo: {
                         newsletterJid: '.forward 120363191125906914@g.us',
...
text: menuc,
  contextInfo: {
    ...
    isForwarded: true,
    forwardedNewsletterMessageInfo: {
      newsletterJid: '120363366147331561@newsletterr',
      serverMessageId: 127
    },
externalAdReply: { 
title: '👨‍💻 ᴋᴀᴠɪ ᴇxᴇ ᴠ1 👨‍💻',
...
await conn.sendMessage(from, {text: vajiralod[i], edit: key })
  ...
  const sections = [
	...
	rows: [
	    {title: "1", rowId: prefix + 'menu' , description: 'COMMANDS MENU'},
	    {title: "2", rowId: prefix + 'ping' , description: '𝗞𝗔𝗩𝗜 𝗘𝗫𝗘 𝗦𝗣𝗘𝗘𝗗'} ,

	]
    } 
]
const listMessage = {
caption: `[𝗞 𝗔 𝗩 𝗜  𝗘 𝗫 𝗘 🐋💗]

   *𝗞𝗔𝗩𝗜 𝗘𝗫𝗘 WHATSAPP USER BOT* 💫
...
🎡 *GITHUB:*  https://github.com/kavi12345786/KAVI-EXE-V1

🪩 *OUR GROUP:* https://chat.whatsapp.com/CQdbw2HVKrpEo0IdaOaUxi
